...
namespace DojoTemplateTestProject.OpCodeTests
{
    public class OpCodeOperationsTests
    {
        ...
        // Less Than or Equals
        [InlineData("3,9,8,9,10,9,4,9,99,-1,8", "3,9,8,9,10,9,4,9,99,1,8", 1, 8)]
        [InlineData("3,9,8,9,10,9,4,9,99,-1,8", "3,9,8,9,10,9,4,9,99,0,8", 0, 4)]
        [InlineData("3,9,7,9,10,9,4,9,99,-1,8", "3,9,7,9,10,9,4,9,99,1,8", 1, 5)]
        [InlineData("3,9,7,9,10,9,4,9,99,-1,8", "3,9,7,9,10,9,4,9,99,0,8", 0, 10)]
        [InlineData("3,3,1108,-1,8,3,4,3,99", "3,3,1108,1,8,3,4,3,99", 1, 8)]
        [InlineData("3,3,1108,-1,8,3,4,3,99", "3,3,1108,0,8,3,4,3,99", 0, 33)]
        [InlineData("3,3,1107,-1,8,3,4,3,99", "3,3,1107,1,8,3,4,3,99", 1, 4)]
        [InlineData("3,3,1107,-1,8,3,4,3,99", "3,3,1107,0,8,3,4,3,99", 0, 8)]
        // jump tests
        [InlineData("3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9", "3,12,6,12,15,1,13,14,13,4,13,99,0,0,1,9", 0, 0)]
        [InlineData("3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9", "3,12,6,12,15,1,13,14,13,4,13,99,666,0,1,9", 1, 666)]
        [InlineData("3,3,1105,-1,9,1101,0,0,12,4,12,99,1", "3,3,1105,0,9,1101,0,0,12,4,12,99,1", 0, 0)]
